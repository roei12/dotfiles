...
Once development of the skill is complete, it must be validated 

```bash
scripts/quick_validate.py <path/to/skill-folder>
```

This will **Validate** the skill automatically, checking:
   - YAML frontmatter format and required fields
   - Skill naming conventions and directory structure
   - Description completeness and quality
   - File organization and resource references

If validation fails, the script will report the errors and exit. Fix any validation errors and run the validation command again.
